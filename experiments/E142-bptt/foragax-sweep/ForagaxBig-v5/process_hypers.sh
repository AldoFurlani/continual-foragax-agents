...
#SBATCH --job-name=E142-bptt_foragax-sweep_ForagaxBig-v5_process_hypers
...
#
# Covers BOTH backbones -- BPTTActorCriticConv_T* and BPTTActorCriticConvStacked_T*
# -- with no argument needed: hypers.py enumerates whatever result directories
# exist, one selection per config file. The stacked agent is 3.5x the params at
...
$SLURM_TMPDIR/.venv/bin/python experiments/E142-bptt/foragax-sweep/ForagaxBig-v5/hypers.py
